...
function Sidebar() {
    ...
    useEffect(()=>{
        ...
        }).then(res=>res.json()).then(data=>{setuser(data[0].email)
        console.log(data[0])})
    },[])
    return (
        <main>
            <div className="sidesection">
                <div className="content-container">
                    ...
                    <div className="total-contacts">
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-address-book" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="white" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <div className="logout-container">
                    <div onClick={handlelogout} style={{cursor:"pointer"}} className="logout">
